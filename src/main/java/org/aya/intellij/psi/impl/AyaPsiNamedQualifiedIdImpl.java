...
public class AyaPsiNamedQualifiedIdImpl extends AyaPsiNamedElementImpl implements AyaPsiNamedWeakId {
  public AyaPsiNamedQualifiedIdImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  /**
   * {@link org.aya.intellij.psi.concrete.impl.AyaPsiAtomBindPatternImpl} is mixin-ed with {@link AyaPsiNamedQualifiedIdImpl},
   ...
   */
  public static abstract class AtomBindPattern extends AyaPsiNamedQualifiedIdImpl implements AyaPsiAtomBindPattern {
